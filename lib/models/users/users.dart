...
class pharmappUser {
  ...
  pharmappUser({required this.id, required this.fullname, required this.email, required this.method, required this.profile_pic_url, required this.addresses, required this.fav_pharms, required this.pre_orders, required this.basket});
}