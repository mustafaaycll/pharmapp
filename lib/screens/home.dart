...
class _HomeState extends State<Home> {
  ...
  List<Address> adresses = <Address>[
    ...
    const Address(
        'Fatih Mah. Fatih Sok. No:11',
        Icon(
          Icons.home,
          color: const Color(0xff44BBA4),
        )),
    const Address(
        '19 Mayıs Mah. Oruç Sok. No:7',
        Icon(
          Icons.home,
          color: const Color(0xff44BBA4),
        )),
    const Address(
        'Kazım Karabekir Mah. Agah Sok. No:45',
        Icon(
          Icons.home,
          color: const Color(0xff44BBA4),
        )),
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                'Previous Orders',
                style: TextStyle(color: AppColors.bodyText, fontSize: 26),
              ),
              SizedBox(height: 15),
              SizedBox(
                  height: 200,
